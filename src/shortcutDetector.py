...
class LightTracker:
    def __init__(self, debugging):
        ...
        self.pub_notification = rospy.Publisher("/shortcutDetection", bool, queue_size=10)
    ...
    def detection(self, img):
        bounds = [["green", [50, 100, 100], [77, 255, 255]], ["red", [0, 130, 130], [10, 255, 255]], ["red", [170, 130, 130], [180,255,255]]]
